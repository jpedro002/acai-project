...
export default function AdminDashboard() {
  ...
  return (
    <div className="flex flex-col h-full gap-6 max-h-[calc(100vh-6rem)]">
      ...
      <header className="flex justify-between items-center bg-surface p-6 rounded-2xl shadow-sm shrink-0">
        ...
        <div className="flex items-center gap-6">
          ...
          <button className="w-10 h-10 rounded-full flex items-center justify-center bg-surface-container-highest hover:bg-surface-variant transition text-on-surface">
