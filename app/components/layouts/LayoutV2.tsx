...
export default function LayoutV2() {
  return (
    <div className="bg-[#FAF9F6] text-on-background font-body min-h-screen overflow-x-hidden w-full relative">
      <LayoutHeader />

      <main className="pt-24 pb-32 px-6 max-w-7xl mx-auto relative z-10 w-full">
        {/* Editorial Background Ornament */}
        <div className="absolute -top-10 -right-20 w-96 h-96 bg-secondary-container/10 rounded-full blur-3xl -z-10"></div>
        <div className="absolute top-1/2 -left-20 w-64 h-64 bg-tertiary-container/5 rounded-full blur-3xl -z-10"></div>

        {/* Welcome Message Section */}
        <section className="mb-12 md:mb-24 mt-6 md:mt-8 w-full">
          <div className="max-w-3xl">
            <span className="text-secondary font-headline font-bold text-xs md:text-sm tracking-[0.2em] uppercase mb-3 md:mb-4 block">
              Bem-vindo à Experiência
            </span>
            <h1 className="text-[#3D0B37] font-headline font-black text-3xl md:text-7xl leading-[0.9] tracking-tighter mb-4 md:mb-6">
              A energia da floresta, <br />
              <span className="text-secondary">em cada detalhe.</span>
            </h1>
            <p className="text-on-surface-variant text-sm md:text-xl max-w-xl leading-relaxed">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-12 lg:gap-20 items-start md:items-center">
          {/* Açaí Floating Card */}
          <div className="group relative bg-surface-container-lowest rounded-xl shadow-[0_32px_64px_rgba(61,11,55,0.06)] overflow-hidden flex flex-col transition-all duration-500 hover:-translate-y-4">
            ...
            <div className="p-6 md:p-12 flex flex-col flex-grow">
              <h2 className="text-[#3D0B37] font-headline font-extrabold text-2xl md:text-4xl mb-3 md:mb-4 tracking-tight">
                O Clássico Açaí
              </h2>
              <p className="text-on-surface-variant text-sm md:text-base mb-6 md:mb-10 leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-tertiary-container rounded-xl p-8 flex flex-col justify-between h-[400px] text-white relative overflow-hidden group">
            ...
            <span className="material-symbols-outlined text-4xl text-[#FFB800]">
              workspace_premium
            </span>
            <div>
